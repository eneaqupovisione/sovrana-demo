...
| `scene-cavallo/` | 24 quadri, 00:53 → 00:54.9, 1600 px | il cavallo del «Caveau»: invertito e in `multiply`, diventa inchiostro sull'acido |
...
- **Caveau** (`#flip`, prima della lista): per circa un viewport di scroll
...
Il nome risponde alla prima riga della canzone — «tutti questi cash dove li
devo mettere?». Ci arriva solo chi ha continuato a scorrere oltre il merch, e
dentro c'è quello che non sta nel menu, in quest'ordine:
